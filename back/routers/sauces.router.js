...
const { getSauces, createSauce, getSaucesById, deleteSauce, modifySauce, likeSauce } = require("../controllers/sauces")
...
saucesRouter.get("/:id", authenticateUser, getSaucesById) //renvoie une sauce spécifique lorsqu'un GET est reçu sur cette route
